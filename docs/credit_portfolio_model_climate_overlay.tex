...
% Title formatting
\title{\textbf{Credit Portfolio Model With Climate Overlay}\\
\large A factor-based framework with deterministic climate/scenario drivers\\and systematic credit factors with market-calibrated correlation structure}
\author{}
\date{\today}
